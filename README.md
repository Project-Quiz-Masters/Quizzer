...
**Swagger (Production)**: [link to the Swagger documentation deployed to the production environment in Rahti](https://rahti-quizzer-quizzer-postgres.2.rahtiapp.fi/swagger-ui/index.html#/)
